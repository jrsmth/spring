...
class VisitControllerTest {
    ...
    private static final String PETS_CREATE_OR_UPDATE_VISIT_FORM = "pet/createOrUpdateVisitForm";
    private static final String REDIRECT_OWNERS_1 = "redirect:/owner/{ownerId}";
    ...
    private final UriTemplate visitsUriTemplate = new UriTemplate("/owner/{ownerId}/pet/{petId}/visit/new");
